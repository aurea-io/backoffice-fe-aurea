        ...
        {primaryTenant ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 space-y-4">
              ...
              {analytics && <div className="grid grid-cols-2 gap-3 sm:grid-cols-4"><Card variant="glass" padding="sm"><p className="text-xs text-zinc-500">Miembros</p><strong className="text-2xl">{analytics.members}</strong></Card><Card variant="glass" padding="sm"><p className="text-xs text-zinc-500">Reservas</p><strong className="text-2xl">{analytics.bookings}</strong></Card><Card variant="glass" padding="sm"><p className="text-xs text-zinc-500">Pedidos</p><strong className="text-2xl">{analytics.orders}</strong></Card><Card variant="glass" padding="sm"><p className="text-xs text-zinc-500">Artículos stock</p><strong className="text-2xl">{analytics.inventoryItems}</strong></Card></div>}
            </div>
